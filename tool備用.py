...
class Button:
    ...
    def update(self, events, mouse_pos):
        ...
        # hover
        self.is_hover = self.rect.collidepoint(mouse_pos) if self.active else False
    ...
    def draw(self, screen: p.Surface, normal_color, hover_color, pressing_color, disabled_color=Colors.GRAY):
